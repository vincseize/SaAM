...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/_TCPDF/exception.class.php');
    require_once(dirname(__FILE__).'/_TCPDF/locale.class.php');
    require_once(dirname(__FILE__).'/_TCPDF/myPdf.class.php');
    require_once(dirname(__FILE__).'/_TCPDF/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/_TCPDF/parsingCss.class.php');
...
'.$content.'
         ...
         * @return boolean
         */
        protected function _tag_open_MYTUBEELEMENT($param)
        {
            // nothing to do here
         ...
         * @return boolean
         */
        protected function _tag_close_MYTUBEELEMENT($param)
        {
            // nothing to do here
